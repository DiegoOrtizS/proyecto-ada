...
### Pregunta 1
#### Elección voraz:
Se analiza comparando las letras de cada una de las n cadenas desde la posición i = (0, 1, …, m-1) y se obtienen m pares con la posición i (first) y la máxima frecuencia de letra (second) para dicha posición. Luego, se ordenan todos estos en base al segundo elemento del par y de forma creciente.
#### Proof: 
